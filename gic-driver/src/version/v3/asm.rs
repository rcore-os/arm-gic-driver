...
pub struct IccSreEl1;
impl Readable for IccSreEl1 {
    type T = u64;
    type R = ICC_SRE_EL1::Register;
    #[inline(always)]
    fn get(&self) -> u64 {
        let reg: u64;
        unsafe { asm!("mrs {0}, ICC_SRE_EL1", out(reg) reg) }
        reg
    }
}
...
pub struct IccSreEl2;
impl Readable for IccSreEl2 {
    type T = u64;
    type R = ICC_SRE_EL2::Register;
    #[inline(always)]
    fn get(&self) -> u64 {
        let reg: u64;
        unsafe { asm!("mrs {0}, ICC_SRE_EL2", out(reg) reg) }
        reg
    }
}
...
pub const ICC_SRE_EL1: IccSreEl1 = IccSreEl1;
pub const ICC_SRE_EL2: IccSreEl2 = IccSreEl2;
